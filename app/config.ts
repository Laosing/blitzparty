export const STORAGE_KEYS = {
  THEME: "drewbox_theme",
  CLIENT_ID: "drewbox_client_id",
  USERNAME: "drewbox_username",
} as const

export const BROADCAST_CHANNEL_NAME = "drewbox_session"
...
export const getThemeGradient = (theme: (typeof THEMES)[number]) => {
  switch (theme) {
    case "light":
